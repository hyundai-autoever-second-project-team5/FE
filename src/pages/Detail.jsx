...
const Detail = () => {
  ...
  const { data: latests } = useGetDetailLatestReviews(movieId);
  const { data: favor } = useGetDetailRecommendReviews(movieId);
  ...
  //             ...review,
  //             heart: liked,
  //             heartCount: liked ? review.heartCount + 1 : review.heartCount - 1,
  //           }
  //         : review
  //     )
  //   );
